...
export declare type NodeDefinition<NodeContent = unknown> = NodeModel<NodeContent> & NodeParameters;
export declare type Element<Descriptor extends GraphDescriptor = GraphDescriptor> = Node<Descriptor> | Link<Descriptor>;
export declare type ElementModel<Descriptor extends GraphDescriptor = GraphDescriptor> = NodeModel<Descriptor['nodeContentType']> | LinkModel<Descriptor['linkContentType']>;
...
export declare class GraphModel<Descriptor extends GraphDescriptor = GraphDescriptor> extends Subscribable<GraphModelEvents<Descriptor>> {
    private _nodes;
    private _links;
