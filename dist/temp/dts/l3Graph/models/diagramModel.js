...
var DiagramModel = /** @class */ (function (_super) {
    ...
    function DiagramModel() {
        ...
        _this.graph.on('add:nodes', _this.groupGraphEvents);
        _this.graph.on('remove:nodes', _this.groupGraphEvents);
        _this.graph.on('update:nodes', _this.groupGraphEvents);
        _this.graph.on('add:links', _this.groupGraphEvents);
        _this.graph.on('remove:links', _this.groupGraphEvents);
        _this.graph.on('update:links', _this.groupGraphEvents);
