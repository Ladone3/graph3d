...
var DefaultLinkOverlayClass = /** @class */ (function (_super) {
...
var DefaultNodeOverlayClass = /** @class */ (function (_super) {
...
exports.DEFAULT_LINK_OVERLAY = { id: 'link-overlay', value: React.createElement(DefaultLinkOverlayClass, { label: '' }) };
exports.DEFAULT_NODE_OVERLAY = { id: 'node-overlay', value: React.createElement(DefaultNodeOverlayClass, { label: '' }) };
...
function enrichOverlay(pooreOverlay, data) {
    var overlayProps = tslib_1.__assign(tslib_1.__assign({}, pooreOverlay.value.props), data);
    return tslib_1.__assign(tslib_1.__assign({}, pooreOverlay), { value: React.cloneElement(pooreOverlay.value, overlayProps) });
}
