...
var GraphView = /** @class */ (function (_super) {
    ...
    GraphView.prototype.createNodeView = function (node) {
        ...
        var nodeTemplate = tslib_1.__assign(tslib_1.__assign({}, customization_1.DEFAULT_NODE_TEMPLATE), templateProvider(node.data));
    ...
    GraphView.prototype.createLinkView = function (link) {
        ...
        var linkTemplate = tslib_1.__assign(tslib_1.__assign({}, customization_1.DEFAULT_LINK_TEMPLATE), templateProvider(link.model));
