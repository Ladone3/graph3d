...
var NodeView = /** @class */ (function () {
    function NodeView(model, template) {
        ...
        if (meshDescriptor) {
            if (meshDescriptor.type === customisation_1.MeshKind.ThreeNative) {
                this.mesh = meshDescriptor.mesh;
            }
            else if (meshDescriptor.type === customisation_1.MeshKind.Primitive) {
                this.mesh = shapeUtils_1.preparePrimitive(meshDescriptor);
            }
            else if (meshDescriptor.type === customisation_1.MeshKind.Obj) {
    ...
    NodeView.prototype.calcScale = function () {
        ...
        var prefferedSize = this.model.size;
        var scale = {
...
var NodeOverlayAnchor = /** @class */ (function (_super) {
    ...
    NodeOverlayAnchor.prototype.enrichOverlay = function (pooreOverlay) {
        return customisation_1.enrichOverlay(pooreOverlay, this.meshModel.data);
    };
    return NodeOverlayAnchor;
}(overlayAnchor_1.AbstractOverlayAnchor));
exports.NodeOverlayAnchor = NodeOverlayAnchor;
var NodeOverlayAnchor3d = /** @class */ (function (_super) {
