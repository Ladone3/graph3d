...
var ReactNodeWidgetView = (function () {
    ...
    ReactNodeWidgetView.prototype.update = function () {
        ...
        if (this.model.focusNode) {
            var curAnchor = this.diagramView.graphView.nodeViews.get(this.model.focusNode).overlayAnchor;
    ...
    ReactNodeWidgetView.prototype.clearNode = function (node) {
        if (node && this.overlay) {
            var view = this.diagramView.graphView.nodeViews.get(node);
            if (view) {
                var anchor = this.diagramView.graphView.nodeViews.get(node).overlayAnchor;
