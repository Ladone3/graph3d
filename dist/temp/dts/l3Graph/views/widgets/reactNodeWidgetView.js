...
var ReactNodeWidgetView = /** @class */ (function () {
    ...
    ReactNodeWidgetView.prototype.update = function () {
        ...
        if (this.model.focusNode) {
            var curAnchor = this.diagramView.graphView.views.get(this.model.focusNode.id).overlayAnchor;
    ...
    ReactNodeWidgetView.prototype.clearNode = function (node) {
        if (node && this.overlay) {
            var view = this.diagramView.graphView.views.get(node.id);
            if (view) {
                var anchor = this.diagramView.graphView.views.get(node.id).overlayAnchor;
