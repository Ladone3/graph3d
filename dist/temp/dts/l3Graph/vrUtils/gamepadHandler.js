...
var GamepadHandler = /** @class */ (function (_super) {
    ...
    GamepadHandler.prototype.registerHighligter = function (controller, highlighter) {
    ...
    GamepadHandler.prototype.handleDragging = function () {
        ...
        this.bearers.forEach(function (bearer, controller) {
            ...
            if (_this.keyPressed.has(bearer.dragKey) && bearer.target) {
                draggElement(_this.diagramView, moveForward ? -exports.GAMEPAD_EXTRA_MOVE_STEP : moveBackward ? exports.GAMEPAD_EXTRA_MOVE_STEP : 0, controller, bearer);
    ...
    GamepadHandler.prototype.updateHighlighting = function (controller, newTarget) {
        ...
        if (newTarget) {
            var view = this.diagramView.graphView.views.get(newTarget.id);
...
function startDragging(target, diagramView, controller, bearer) {
    if (target && target instanceof node_1.Node) {
        var elementMesh = diagramView.graphView.views.get(target.id).mesh;
        if (controller) {
...
function draggElement(diagramView, zOffset, controller, bearer) {
    if (bearer) {
        if (controller) {
