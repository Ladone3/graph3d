...
function preparePrimitive(primitive) {
    if (primitive.type !== customisation_1.MeshKind.Primitive) {
...
function setColor(mesh, providedColor) {
    var color = typeof providedColor === 'string' || typeof providedColor === 'number' ? providedColor : providedColor.get(mesh);
