...
var Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.render = function () {
        ...
        var selectedViewController = this.state.selectedViewController;
        return React.createElement("div", { className: 'l3graph-toolbar' },
            ...
            viewControllers.map(function (viewController, index) {
                return React.createElement("button", { title: viewController.label, key: "controller-button-" + index, className: selectedViewController === viewController ? 'l3graph-selected' : '', onClick: function () { _this.setViewController(viewController); } }, viewController.label[0]);
            }),
