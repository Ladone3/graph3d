...
export declare type ViewControllersSet<Descriptor extends GraphDescriptor> = ((view: DiagramView<Descriptor>, mouseHandler: MouseHandler<Descriptor>, keyHandler: KeyHandler, gamepadHandler: GamepadHandler<Descriptor>) => ViewController)[];
