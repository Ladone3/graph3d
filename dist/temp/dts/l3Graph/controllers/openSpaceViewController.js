...
var OpenSpaceViewController = /** @class */ (function () {
    ...
    OpenSpaceViewController.prototype.stepLeft = function () {
        ...
        this.position = this.limitPosition({
            x: this.position.x + cameraDirection.z * viewController_1.CAMERA_STEP_SPEED,
            y: this.position.y,
            z: this.position.z - cameraDirection.x * viewController_1.CAMERA_STEP_SPEED,
        });
        this.updateCameraPosition();
    };
    ...
    OpenSpaceViewController.prototype.limitPosition = function (targetPosition) {
        ...
        if (distanceToTheCenter > maxRadius) {
            ...
            var diffDirection = utils_1.miltiply(directionToTheCenter, distanceToTheCenter - maxRadius);
