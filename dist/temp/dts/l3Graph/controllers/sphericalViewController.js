...
var SphericalViewController = (function (_super) {
    ...
    function SphericalViewController(core, mouseHandler, keyHandler) {
        ...
        _this.onKeyPressed = function (event) {
            ...
            if (keyMap.has(keyHandler_1.KEY_CODES.MINUS) && !keyMap.has(keyHandler_1.KEY_CODES.PLUS)) {
                _this.zoom(-10);
            }
            else if (keyMap.has(keyHandler_1.KEY_CODES.PLUS) && !keyMap.has(keyHandler_1.KEY_CODES.MINUS)) {
                _this.zoom(10);
            }
            _this.setCameraAngle({
        ...
        _this.id = 'spherical-core-controller';
