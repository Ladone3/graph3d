...
declare module 'l3-graph/l3Graph/utils/shapeUtils' {
    import * as THREE from 'three';
    import { MeshPrimitive } from 'l3-graph/l3Graph/templates';
...
declare module 'l3-graph/l3Graph/utils/geometry' {
    ...
    export function handleDragging(downEvent: MouseEvent, onChange: (event: MouseEvent, change: Vector2D) => void, onEnd?: (event: MouseEvent, change: Vector2D) => void): void;
