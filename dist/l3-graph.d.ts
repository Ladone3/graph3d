...
declare module 'l3-graph' {
    ...
    export { NodeDefinition } from 'l3-graph/l3Graph/models/graph/graphModel';
    export { NodeViewTemplate, LinkViewTemplate, MeshKind, L3Mesh, MeshObj, MeshPrimitive, THREE, DEFAULT_NODE_TEMPLATE, DEFAULT_NODE_TEMPLATE_PROVIDER, DEFAULT_LINK_TEMPLATE, DEFAULT_LINK_TEMPLATE_PROVIDER, NodeTemplateProvider, LinkTemplateProvider, } from 'l3-graph/l3Graph/customisation';
    ...
    export { LeftGamepadTool, RightGamepadTool } from 'l3-graph/l3Graph/views/widgets/gamepadTools/defaultTools';
...
declare module 'l3-graph/l3Graph/l3Graph' {
    ...
    import { ReactOverlay } from 'l3-graph/l3Graph/customisation';
...
declare module 'l3-graph/l3Graph/views/diagramView' {
    ...
    import { NodeTemplateProvider, LinkTemplateProvider } from 'l3-graph/l3Graph/customisation';
...
declare module 'l3-graph/l3Graph/customisation' {
    export * from 'l3-graph/l3Graph/customisation/defaultLinkTemplate';
    export * from 'l3-graph/l3Graph/customisation/defaultNodeTemplate';
    export * from 'l3-graph/l3Graph/customisation/defaultOverlay';
    export * from 'l3-graph/l3Graph/customisation/mesh';
    export * from 'l3-graph/l3Graph/customisation/templates';
}
...
declare module 'l3-graph/l3Graph/views/widgets/gamepadTools/editorTools' {
    ...
    import { GamepadTool } from 'l3-graph/l3Graph/views/widgets/gamepadTools/defaultTools';
    import { DiagramModel } from 'l3-graph/l3Graph/models/diagramModel';
    import { Element, NodeDefinition } from 'l3-graph/l3Graph/models/graph/graphModel';
    import { VrManager } from 'l3-graph/l3Graph/vrUtils/vrManager';
...
declare module 'l3-graph/l3Graph/views/viewInterface' {
    ...
    import { Widget } from 'l3-graph/l3Graph/models/widgets/widget';
    import { AbstracrOverlayAnchor3d } from 'l3-graph/l3Graph/views/graph/overlay3DAnchor';
...
declare module 'l3-graph/l3Graph/defaultWidgetsSet' {
    ...
    import { WidgetFactory } from 'l3-graph/l3Graph/models/widgets/widget';
    import { GamepadsWidget } from 'l3-graph/l3Graph/models/widgets/gamepadsWidget';
    import { StateTesterModel } from 'l3-graph/l3Graph/views/widgets/stateControllerTester';
...
declare module 'l3-graph/l3Graph/models/diagramModel' {
    ...
    import { Subscribable, EventObject } from 'l3-graph/l3Graph/utils/subscribeable';
    import { Node } from 'l3-graph/l3Graph/models/graph/node';
    import { Link } from 'l3-graph/l3Graph/models/graph/link';
...
declare module 'l3-graph/l3Graph/customisation/defaultLinkTemplate' {
    import { LinkViewTemplate, LinkTemplateProvider } from 'l3-graph/l3Graph/customisation';
    export const DEFAULT_LINK_TEMPLATE: LinkViewTemplate;
    export const DEFAULT_LINK_TEMPLATE_PROVIDER: LinkTemplateProvider;
}

declare module 'l3-graph/l3Graph/customisation/defaultNodeTemplate' {
    import { NodeViewTemplate, NodeTemplateProvider } from 'l3-graph/l3Graph/customisation/templates';
...
declare module 'l3-graph/l3Graph/customisation/defaultOverlay' {
    import * as React from 'react';
    import { ReactOverlay } from 'l3-graph/l3Graph/customisation';
...
declare module 'l3-graph/l3Graph/customisation/mesh' {
    import { Vector3d } from 'l3-graph/l3Graph/models/structures';
...
declare module 'l3-graph/l3Graph/customisation/templates' {
    import * as React from 'react';
    import { L3Mesh } from 'l3-graph/l3Graph/customisation/mesh';
...
declare module 'l3-graph/l3Graph/views/widgets/stateControllerTester' {
    import * as THREE from 'three';
    import { DiagramWidgetView } from 'l3-graph/l3Graph/views/viewInterface';
    import { KeyHandler } from 'l3-graph/l3Graph/utils';
    import { Widget } from 'l3-graph/l3Graph/models/widgets/widget';
...
declare module 'l3-graph/l3Graph/utils/shapeUtils' {
    import * as THREE from 'three';
    import { MeshPrimitive, MeshObj } from 'l3-graph/l3Graph/customisation';
...
declare module 'l3-graph/l3Graph/utils/geometry' {
    import * as THREE from 'three';
    import { Vector3d, Vector2d } from 'l3-graph/l3Graph/models/structures';
    import { Size } from 'l3-graph/l3Graph/models/graph/node';
